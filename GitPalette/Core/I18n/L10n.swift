...
enum L10nKey: String, Sendable {
    ...
    case gitStatusConflicted
    case gitStatusCopied
    case hotkeyConflictHint
...
enum L10n {
    ...
    private static let english: [L10nKey: String] = [
        ...
        .hotkeyConflictHint: "The current hotkey %@ may conflict with a system shortcut. Adjust it in System Settings → Keyboard → Keyboard Shortcuts, or change the GitPalette hotkey.",
        .gitWorkingTreeClean: "Working tree clean",
        .gitErrorNoLinkedRepository: "No repository linked. Run /git link first.",
        .gitErrorPathDoesNotExist: "Path does not exist: ",
        .gitErrorNotGitRepository: "Not a git repository: ",
        .gitErrorRepositoryNameNotFound: "Linked repository not found: ",
        .gitErrorProcessLaunchFailed: "Failed to start git: ",
        .gitErrorNonZeroExit: "git command failed: ",
        .gitErrorNoStagedChanges: "No staged changes to commit.",
        .gitErrorNoSelectedPaths: "Select files with Space before adding.",
        .gitErrorRepositoryPathInvalid: "Repository path is no longer valid: ",
        .gitCommitSucceeded: "Commit succeeded, files ",
        .gitCommitFileCountSuffix: ", revision ",
        .gitLinkSucceeded: "Linked repository: ",
        .gitUseSucceeded: "Switched to repository: ",
        .gitUnlinkSucceeded: "Unlinked repository: ",
        .gitUnlinkNeedsUse: "No active repository. Run /git use or /git link.",
        .gitReposActiveMark: "active",
        .gitResultRunning: "Running…",
    ...
    private static let simplifiedChinese: [L10nKey: String] = [
        ...
        .gitStatusCopied: "已复制",
        .hotkeyConflictHint: "当前热键 %@ 可能与系统快捷键冲突。请到「系统设置 → 键盘 → 键盘快捷键」中调整，或更改 GitPalette 热键。",
